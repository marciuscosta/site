					...
					<div class="entry-content">
						...
						if ( is_singular() ) :
							...
							if ( ! has_post_format( 'image' ) && ! has_post_format( 'quote' ) ) :
								the_excerpt();
								/* if ( is_rtl() ) :
									echo '<div class="read-more-area"><a href="' . esc_url( get_the_permalink() ) . '"> ' . esc_html__( 'Leia', 'minnak' ) . ' &xlarr;</a></div>';
								else :
									echo '<div class="read-more-area"><a href="' . esc_url( get_the_permalink() ) . '"> ' . esc_html__( 'Leia', 'minnak' ) . ' &xrarr;</a></div>';
								endif; */
							endif;
						endif;
						wp_link_pages(
